...
# 概要
  ・各店舗でメニューを１２品限定で掲載するアプリです。（メニュー掲載サイト）
...
# 機能閲覧
・私のポートフォリオにある『３、作品等』の下部には、スクロールでアプリの全てのビューや、作品を作る上での調べたこと等をまとめたものがあります！
ここからどうぞ！https://portfolio-28408.herokuapp.com/
※　個人情報保護の観点から、ユーザー認証機能を導入してます。閲覧する方は、お気軽にご一報ください！
...
### 解決したい課題等
・資金面を押さえた上で落ち込んだ顧客を呼び戻したい。
・また欲を言えばリピーターを増やし、既存客による収益から経営基盤を安定させたい。
↓
・顧客の不安要素を取り除けば客足は回復の目処がたちのではないか。
・満足度の上がる工夫を取り入れれば良いのではないか。
↓
・顧客の不安要素のある、何かを取り除けるシステムが欲しい
・顧客の満足度の上がる何かが欲しい。

##### 衛生面の可視化、空き時間の可視化、共通接触物の排除、マイ箸等の持参物の推進等
##### 満足度を上げるために行動経済学、選択のパラドックスの考え方を応用
...
外食する上での不安要素を消したい
↓
衛生対策や人の混雑具合が把握でき、それを避けられるよう可視化したものがあれば良いのではないか。
↓
衛生面の可視化
...
# 工夫したポイント
  ...
  ・アプリ運営側の収益を広告以外に設けるために、QRコードは低価格ながら有料化しました。


## このサイトのお客様の価値とは
１、メニューがまとめられていてシンプルで見やすい。
２、各お店のカウンターやテーブルに設置してもらうことで、そこにあるQRコードから直接サイトへ飛べる。
３、メニュー表示方法が統一されていて、他の店舗を閲覧していても既視感による扱いやすさを実現。
４、目に可視化されづらい、衛生面に対する店舗側の努力が可視化されている。
５、混雑具合が表示されており、人混みを回避して向かうことが可能になる
６、全員が触るであろうメニュー表を触らずに済み、感染リスクを下げることができる。また不安要素の排除に繋がる。


## このサイトの事業者側の価値とは
８、メニュー表を印刷する量が減り、衛生面で毎度行う消毒等の機会も減り、コストカットにつながる。
９、メニュー表示を工夫することで客単価の増加を見込める。
１０、使用料金は無料なため、使用するハードルが低い。
１１、感染症を不安に思う方の層の一部回復。
１２、メニューの記載も面倒であれば代行していただける。


## 制作前には想定しなかった付加価値
７、利用者が増加すればメニュー表を回すという機会が減り、それぞれがメニューを見出すことから、今まで足し算であったメニューを選ぶ時間は、最大値のみとなりお客様の回転率をあげることにつながる。
